import Sprite = Laya.Sprite;
    ...
    export class DrawTextureSwitch {
        private texture1: string = "../laya/assets/comp/radio.png";
        private texture2: string = "../laya/assets/comp/img_bg.png";
